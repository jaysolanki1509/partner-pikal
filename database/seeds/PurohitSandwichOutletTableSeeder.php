...
class PurohitSandwichOutletTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $Outlet=Outlet::where('name','Purohit Sandwich')->first();
        $OutletId=$Outlet->id;
        ...
        $OutletImages = array(
            array('outlet_id' => $OutletId,'image_name'=>'purohit-01.jpg'),
            array('outlet_id' => $OutletId,'image_name'=>'purohit-02.jpg'),
            array('outlet_id' => $OutletId,'image_name'=>'purohit-03.jpg'),
            array('outlet_id' => $OutletId,'image_name'=>'purohit-04.jpg'),
        );
        ...
        $timing = array(
            array('outlet_id'=>$OutletId,'from_time'=>'9:00 AM','to_time'=>'10:30 PM'),
        );
