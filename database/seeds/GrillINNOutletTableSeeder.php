...
class GrillINNOutletTableSeeder extends Seeder
{
    public function run()
    {
        ...
        //Insert Outlet_types
        $Outlet=Outlet::where('name','Grill INN')->first();
        $OutletId=$Outlet->id;
        ...
        $OutletImages = array(
            array('outlet_id' => $OutletId,'image_name'=>'grillin-01.jpg'),
            array('outlet_id' => $OutletId,'image_name'=>'grillin-02.jpg'),
            array('outlet_id' => $OutletId,'image_name'=>'grillin-03.jpg'),
            array('outlet_id' => $OutletId,'image_name'=>'grillin-04.jpg'),
            array('outlet_id' => $OutletId,'image_name'=>'grillin-05.jpg'),
            array('outlet_id' => $OutletId,'image_name'=>'grillin-06.jpg'),
            );
        ...
        $Outlet_latlong = array(
            array('outlet_id'=>$OutletId,'latitude'=>23.023883,'longitude'=>72.470957),
        );
        ...
        $timing = array(
            array('outlet_id'=>$OutletId,'from_time'=>'11:00 AM','to_time'=>'11:00 PM'),
        );
