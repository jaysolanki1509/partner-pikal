...
class Outlet extends Model
{
    ...
    {
        return $this->hasMany('App\order_details','outlet_id');
    }
    ...
    public static function getTotalHours($outlet_id,$start_date){
        $first = order_details::where('outlet_id',$outlet_id)->wherebetween('table_start_date',array($start_date,Carbon::parse($start_date)->endOfDay()))
               ->first();
        $last = order_details::where('outlet_id',$outlet_id)->wherebetween('table_start_date',array($start_date,Carbon::parse($start_date)->endOfDay()))
