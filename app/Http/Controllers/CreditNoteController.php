...
class CreditNoteController extends Controller
{
    ...
    public function create($order_id)
    {
        ...
        $order_detail = $orders = OrderDetails::join("order_items", "order_items.order_id", "=", "orders.order_id")
            ...
            ->select(
                ...
                'order_items.item_total as item_total',
                'order_items.item_id as item_id',
                'order_items.tax_slab as itm_tax',
                'order_items.item_discount as itm_discount',
        ...
        if (isset($order_detail) && sizeof($order_detail) > 0) {
            ...
            if ($order_detail[0]->outlet_id != $outlet_id) {
                echo "Provided Invoice number is not valid, Please try valid invoice number.";
                exit;
            }
    ...
    public function getCraditNote()
    {
        ...
        $order = OrderDetails::find($creditNote->order_id);
