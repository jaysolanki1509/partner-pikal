...
//            print_r($locality);exit;
        ...
        return view('Outlets.show',array('sources'=>$sources,'payment_options'=>$payment_options,
                                        ...
                                        'menuitems'=>$menuitems,'Outletimages'=>$rest_images,
                                        'image'=>$image,'Outlet_latlong'=>$rest_latlong,
                                        'Outletsectioname'=>$Outletsectioname,'timeslot'=>$timeslot,
                                        'states'=>$states,'cities'=>$cities,'locality'=>$locality,
                                        'established_date'=>$established_date,'active'=>$active,
                                        'countries'=>$countries, 'printers'=>$printers,
                                        'dp_kot_count'=>$dup_kot_count,
                                        'delivery_charge'=>$delivery_charges,
                                        'tax_details'=>$tax_details,'zoho_username'=>$zoho_username,
    ...
    public function edit($id)
    {
        ...
        //print_r($users);exit;
        return view('Outlets.edit',array('payment_options'=>$payment_options,
...
//            print_r($locality);exit;
            ...
            return view('Outlets.showfields',array('sources'=>$sources,'payment_options'=>$payment_options,
                'payment_options_without_source'=>$payment_options_without_source,
                'outlet'=>$Outlet,'tinno'=>$tinno,'settings'=>$settings,
                'servicetax_no'=>$servicetax_no,'service_type'=>$service_type,
                'Outlettype'=>$Outlet_type,'cuisinetypes'=>$cuisinetype,
