...
class StocksController extends Controller {
	...
	public function index(Request $request)
	{
		...
		if ($request->ajax())
		{
            ...
            $loc_ids = '';
            if ( isset($my_location) && !empty($my_location) ) {
        ...
        if ( isset($units_arr) && !empty($units_arr) ) {
                            ...
                            if ( isset($recipe) && !empty($recipe) ) {
                                ...
                                if ( isset($ingreds) && !empty($ingreds) ) {
                                    foreach( $ingreds as $ing ) {
                                        if ( isset($selected_itm_arr) && !empty($selected_itm_arr) ) {
                ...
                try {
                    if ( isset($ingreds) && !empty($ingreds) ) {
                        foreach( $ingreds as $ing ) {
                            ...
                            if ( !isset($check_consume) && ($check_consume) == 0 ) {
    ...
    public static function onCancelChangeStock($order_id,$default_location) {
        ...
        if ( isset($order_id) && $order_id != '' ) {
            ...
            if ( isset($ord_item) && !empty($ord_item) ) {
    ...
    public static function manuallyRevokeStock( $order_item,$location_id, $owner_id ) {
        ...
        if ( isset($order_item)) {
            ...
            if ( isset($order_id) && $order_id != '' ) {
                ...
                if ( isset($check_record) && !empty($check_record) ) {
                            ...
                            if ( isset($stock) && !empty($stock) ) {
                                ...
                                if ( $result ) {
                                    ...
                                    if ( $result1 ) {
                                        ...
                                        if ( isset($st_age_result) && !empty($st_age_add) ) {
