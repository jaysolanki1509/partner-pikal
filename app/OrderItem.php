...
class OrderItem extends Model {
    ...
    {
        return $this->belongsTo('App\order_details','order_id','id');
    }
    ...
    public static function insertmenuitemoforders($saveorder,$orderitem,$rest_id,$inv_no = NULL)
    {
        ...
        if ( isset($orderitem['item_options']) && sizeof($orderitem['item_options'] > 0 )) {
        ...
        if (isset($orderitem['item_id'])) {
            ...
            if ( $inv_no == "" || $inv_no == null ) {
                ...
                //get order object
                $order_obj = order_details::where('order_id',$saveorder)->first();
        ...
        if (isset($orderitem['item_id'])) {
            ...
            if (isset($menu_title_detail) && sizeof($menu_title_detail) > 0) {
                ...
                if ( isset($orderitem['titleName']) && $orderitem['titleName'] != '') {
                    ...
                    if (isset($title_detail) && sizeof($title_detail) > 0) {
