            ...
            <div class="widget-wrap">
                <div class="widget-header block-header clearfix j-forms">
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <button type="button" class="btn btn-success primary-btn pull-left" id="print_btn" onclick="printData()">Print</button>
                    </div>
                </div>
...
@section('page-scripts')
    ...
    <script type="text/javascript">
        ...
        function printData()
        {
            var divToPrint=document.getElementById("police-report");
            newWin= window.open("");
