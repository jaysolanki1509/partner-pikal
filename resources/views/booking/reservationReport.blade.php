            ...
            <div class="widget-wrap">
                <div class="widget-header block-header clearfix j-forms">
                    ...
                    <div class="col-md-2 form-group">
                        {!! Form::select('reservation_type',['reservation'=>'Reservation','temp-reservation'=>'Temp-Reservation'], 'reservation', array('id'=>'reservation_type','class' => 'form-control')) !!}
                    </div>
                    <div class="col-md-2 form-group">
    ...
    <script type="text/javascript">
        ...
        function getList() {
            ...
            $.ajax({
                ...
                type: "post",
                data: { from_date:from,to_date:to,reservation_type:reservation_type},
