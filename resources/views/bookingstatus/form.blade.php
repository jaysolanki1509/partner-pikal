    ...
    <div class="widget-wrap">
        <div class="widget-container">
            <div class="widget-content">
                @if($action=='edit')
                    {!! Form::model($booking_status,['route' => array('booking-status.update',$booking_status->id), 'method' => 'patch', 'id' => 'bookingStatusForm', 'class' => 'form-horizontal material-form j-forms']) !!}
                @else
                    {!! Form::open(['route' => 'booking-status.store', 'method' => 'post', 'class' => 'form-horizontal material-form j-forms', 'id' => 'bookingStatusForm']) !!}
                @endif

                <div class="form-group">
                    <div class="row">
                        <div class="col-md-8">
                            {!! Form::label('name','Booking Status Name*:', array('class' => 'col-md-12 control-label')) !!}
                            <div class="col-md-12">
                                {!! Form::text('name', null, array('class' => 'col-md-3 form-control','id' => 'name', 'placeholder'=> 'Booking Status Name','required')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-footer">
                    <div class="col-md-8">
                        @if($action=='edit')
                            ...
                            {!! HTML::decode(HTML::linkRoute('booking-status.index','Cancel', array(), array('class'=>'btn btn-danger primary-btn', 'id'=>''))) !!}
                        @else
