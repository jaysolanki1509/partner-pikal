        ...
        <div class="col-md-12">
            <div class="widget-wrap">
                <div class="widget-header block-header clearfix j-forms">
                    <form class='j-forms'>
                        <input type="hidden" value="export" name="flag" id="flag">
                        ...
                        <div class="col-md-3">
                            <button type="button" class="btn btn-success primary-btn pull-left" id="show_btn" onclick="getList('report')">Show</button>
                            <button type="submit" style="margin-left: 10px;" class="btn btn-success pull-left" id="export_btn" >Export</button>
                        </div>
                    </form>
...
@section('page-scripts')
    ...
    <script type="text/javascript">
        ...
        function getList() {
            ...
            $.ajax({
                url: '/stock-response-report',
                type: "post",
                data: { flag:'report',request_type:'response',from_date:from,to_date:to,user_id:user_id,location_id:location_id,request:'web'},
