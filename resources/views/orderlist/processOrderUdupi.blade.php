...
<div id="processBilludupi" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 form-group">
                        <button type="button" class="btn btn-primary" onclick="calculateUdupiDiscount( this, 'process', 'apply' )">Apply</button>
                        <button type="button" class="btn btn-danger" onclick="calculateUdupiDiscount( this, 'process', 'remove' )">Remove</button>
                    </div>
                </div>
                <?php
            ...
            <div class="modal-footer">
                <button type="button" onclick="addPaymentMode('#processBilludupi')" id="process_add_payment_mode_btn" class="btn btn-primary"><i class="fa fa-plus"></i> Payment Mode</button>
                <button type="button" id="process_btn" class="btn btn-primary" onclick="processBilludupihome(0,'process')">Print Bill</button>
