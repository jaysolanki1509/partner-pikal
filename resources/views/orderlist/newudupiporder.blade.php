                ...
                <div class="widget-container" style="margin-top: 0px; height: 100%;">
                    <div class="widget-content" style="height: 100%;">
                        ...
                        @else
                                            ...
                                            <ul class="nav material-tabs scrollmenu" role="tablist">
                                                ...
                                                @foreach ($menu as $key => $m)
                                                    <li class="xyz @if ($i == 1) active @endif"
                                                        onclick="changeSelect(this,{{ json_encode($key) }})">
                                                        <a
                                                            href="#{{ preg_replace('/[^A-Za-z0-9\-]/', '-', $key) }}">{{ $key }}
                                                        </a>
                                                    </li>
                            ...
                            <div class="col-md-7 col-sm-7" id="menus_div" style="padding-left: 0px; height: 100%;">
                                    ...
                                    <div id="container" class="custom-class" style="float:left;width:100%;">
                                        <ul class="keyboard">
                                            ...
                                            <li class="letter" onclick="addvalue(this,'del')">.</li>
                            ...
                            <div class="col-md-3 col-sm-3" id="cart_div" style=" padding: 4px; ">
                                ...
                                {{-- <div class="col-md-6" style="padding: 0px !important;margin-top: 10px">
                                    <button class="btn btn-primary pull-right" onclick="openItem('open')"><i
                                            class="fa fa-plus"></i> Open Item</button>
                                </div> --}}
                                <div class="col-md-12" style="padding: 0px  !important;margin-top: 10px">
                                    <td  >
                                        ...
                                        {{-- <li style="float: none;border: 0; list-style: none;"><input type="text" id="myInput"
                                                        onkeyup="myFunction()" placeholder="Search..."></li> --}}
                                    </td>
                                </div>
                                ...
                                <table id="summary-table" class="table table-hover table-striped">
                                    <tr>
                                        ...
                                        <td id="new-order-sub-total" style="text-align: right;font-weight: bolder">0.00</td>
                                    </tr>
                                    <tr>
                                        <td style="font-weight: bolder">Total:</td>
                                        <td id="new_order_total" style="text-align: right;font-weight: bolder">0.00</td>
                                    </tr>
                                </table>
                                <div style="clear: both"></div>
                                ...
                                <div class="dine_in_field">
                                    <div class="col-md-6" style="padding: 0px;font-weight: bold">
                                        <lable>
                                            ...
                                            required value="{{ $tableno }}" class="form-control">
                                    </div>
                                    {{-- required value="{{ request()->segment(2) }}" --}}
                                    <div class="col-md-6" style="padding: 0px;font-weight: bold">
                                        <lable>No. of Person</lable><input type="number"
                                            onchange="remove_error('person_no')" id="person_no" required
                                            value="{{ 1 }}" class="form-control">
                                    </div>
                                    {{-- required value="{{ last(request()->segments()) }}" --}}
                                </div>
                                ...
                                {{-- <div class="col-md-4 pull-left" style="margin-top: 10px; ">
                                    <button id="print_kot_btn" class="btn btn-primary pull-right"
                                        onclick="printkot()" style="margin-bottom: 20px">Kot</button>
                                </div> --}}
                                {{-- <div class="col-md-4 pull-right" style="padding-right:0px; margin-right: 5px ">
                                    <button id="cancel_order_btn" class="btn btn-danger pull-right"
                                        onclick="cancelOrder()" style="margin-bottom: 20px">Cancel Order</button>
                                </div> --}}
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.message == 'success' || data.message == 'firebase error') {
                        ...
                        // }, function(isConfirm) {
                        //     if (isConfirm) {
                            processDisBilludupihome(data.order_id, 'open');
                        //         swal.close();
        ...
        function additem(e, flag, option_arr, attributes_arr,name,price,val,item_id) {
            ...
            var html = '<tr id="' + item_id + '">' +
                ...
                // '</button>' +
                // '</span>' +
                '<input style="text-align: center; padding: 0; height: 26px;" text-align: center;" onchange="changeCalculation(this)" type="text" name="quant[2]" class="form-control input-number" value="' +
                val + '" min="1" max="1000">' +
                // '<span class="input-group-btn">' +
                // '<button type="button" class="btn btn-success btn-number" onclick="changeNumber(this)" data-type="plus" data-field="quant[2]">' +
                // '<span class="glyphicon glyphicon-plus"></span>' +
        ...
        function myFunction() {
            // Declare variables
            var input, filter, table, tr, a, i,ul,li;
            input = document.getElementById('myInput');
            console.log(input);
            filter = input.value.toUpperCase();
            table = $("#myUL");
            tr = $("#myUL")[0].getElementsByTagName('li');
            console.log(tr);
            // Loop through all list items, and hide those who don't match the search query
            for (i = 0; i < tr.length; i++) {
                a = tr[i].getElementsByTagName("li")[0];
