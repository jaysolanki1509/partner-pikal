                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                            ...
                            <div class="col-md-12 padding-left0 padding-right0" style="padding-left: 0px;padding-right: 0px">
...
{{--                                                                <td class="text-center">{!! $request->existing_qty !!}</td>--}}
                        ...
                        {!! Form::input('hidden','request_data' , isset($print_data) ? $print_data : null, ['class' => 'form-control','id'=>'request_data' ] ); !!}
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function printData() {
        window.ResponseData.responseData($('#request_data').val());
    }
