        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Process Request Place <a href="/requestItemProcess" style="float: right;">Back</a> </div>
                    <div class="panel-body">
                        ...
                        {{--<form class="form-horizontal" role="form" method="GET" id="getRequestedItem" novalidate="novalidate" action="{{ url('/ajax/getRequestedItems') }}" files="true" enctype="multipart/form-data">
                            <div class="col-md-12" >
                                <div class="col-md-2"></div>

                                --}}{{--<div class="col-md-3">
                                    {!! Form::text('date', isset($date)?$date:date('Y-m-d'), ['class' => 'form-control from_date','placeholder' => "Select Date", 'id' => "date", 'readonly'=>"readonly"]) !!}
                                </div>--}}{{--

                                <div class="col-md-3">
                                    {!! Form::text('from_date', isset($from_date)?$from_date:date('Y-m-d'), ['class' => 'form-control from_date','placeholder'=>"Select Date","id"=>"from_date"]) !!}

                                </div>

                                <div class="col-md-3">
                                    {!! Form::text('to_date', isset($to_date)?$to_date:date('Y-m-d'), ['class' => 'form-control to_date','placeholder'=>"Select Date","id"=>"to_date"]) !!}
                                ...
                                <div class="col-md-3 form-group">
                                    <input type="submit" name="show" class="btn btn-primary" id="showbtn" value="Show" style="float: right; margin-right: 50%">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    @foreach( $item_requests as $item_request )
                                        <div class="row well" >
                                            ...
                                            <div class="col-md-3" style="margin-top: 5px;">
                                                {!!Form::text('satisfied_date',null,array('placeholder'=>'Satisfied Date','class'=>'form-control','id'=>'satisfied_date','readonly'))!!}
                                            </div>
                                            <div style="clear: both"></div>

                                            <div class="col-md-3" style="margin-top: 5px;">
                                                <button type="button" class="btn btn-primary" onclick="getProcessStockDetail()" id="next_btn">Next</button>
                                            </div>
                                            <div style="clear: both"></div>

                                            <hr class="col-md-12" style="margin-top: 5px;">
                                            <div style="clear: both"></div>
                                                        ...
                                                        @if(sizeof($requests) > 0)
                                                            ...
                                                            @foreach($requests as $request)
                                                                <tr id="{!! $request->item_id !!}" data-item-id="{!! $request->what_item_id !!}">
                                                                    ...
                                                                    {{--<td class="text-center">{!! $request->existing_qty !!} {!! $request->unit !!}</td>--}}
    ...
    <script>
        ...
        function getProcessStockDetail() {
            ...
            if( loc_id == '' || satisfied_date == '' ) {
                alert('please select location and satisfied date');
                return;
            } else if ( loc_id == '') {
                alert('Please select location');
                return;
            ...
            $.ajax({
                ...
                type:'POST',
                data:'view=mobile&loc_id='+loc_id+'&satisfied_date='+satisfied_date+'&user_id='+user_id+'&loc_text='+loc_text,
        ...
        function validateForm() {
            ...
            if ( error == "error_stock" ) {
                alert('Please check the field highlighted in red. Satisfied Quantity must not be greater than Total Stock.');
                return false;
            }
