...
<style type="text/css">
    ...
    * { -webkit-text-size-adjust: none; }
    ...
    @media (max-width: 768px){
        ...
        img{ max-width: 97%; height: auto; width: auto\\9; /* ie8 */ }
    }
...
<table class="table" border="0" align="center" cellspacing="0" cellpadding="0" style="border:1px solid #cccccc; width:700px; background-color:#cfcfcf; display:block;">
                ...
                <tr>
                    <td>
                        <table class="table-1" border="0" align="center" cellspacing="0" cellpadding="0" style="width:642px; background-color:#ffffff;">
                            <tr>
                                <td height="70" width="642" align="center" valign="middle" style="font-size:18px;font-family: 'Lato', sans-serif;">
                                    <span style="font-size:24px;">{{ $data['outlet_name'] }}</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table class="table-1" border="0" align="center" cellspacing="0" cellpadding="0" style="width:210px; height:80px; margin-bottom:2px;">
                                        ...
                                        <tr>
                                            <td height="48" class="amount-3"  width="210"align="center" style="color:#333333; font-size:24px; font-family: 'Lato', sans-serif;vertical-align: middle;">&#8377; {{ $data['total_unpaid'] or 0.00 }} </td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
    ...
    <tr>
        <td align="center" width="642" height="50" valign="middle" style="font-size:12px; color:#666666; font-family: 'Lato', sans-serif;">
